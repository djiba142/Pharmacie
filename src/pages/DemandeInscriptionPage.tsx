      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {step === 0 && (
              <>
                <div className="space-y-2"><Label>Type de structure *</Label>
                  <Select value={form.type_structure} onValueChange={v => setForm({...form, type_structure: v})}>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2"><Label>Préfecture *</Label><Input value={form.prefecture} onChange={e => setForm({...form, prefecture: e.target.value})} /></div>
                </div>
              </>
            )}
            ...
            {step === 1 && (
              <>
                <div className="space-y-2"><Label>Nom de la structure *</Label><Input value={form.nom_structure} onChange={e => setForm({...form, nom_structure: e.target.value})} /></div>
            ...
            {step === 2 && (
              <>
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2"><Label>Nom *</Label><Input value={form.responsable_nom} onChange={e => setForm({...form, responsable_nom: e.target.value})} /></div>
                  <div className="space-y-2"><Label>Prénom *</Label><Input value={form.responsable_prenom} onChange={e => setForm({...form, responsable_prenom: e.target.value})} /></div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div key={doc.label} className="flex items-center justify-between p-3 rounded-lg border border-border">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <label className="cursor-pointer">
                        <input type="file" className="hidden" accept=".pdf,.jpg,.jpeg,.png" onChange={e => handleFileChange(doc.label, e.target.files?.[0] || null)} />
