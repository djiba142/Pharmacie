        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="bg-muted rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-semibold text-foreground">Comptes de démonstration</span>
            </div>
            <div className="space-y-1 text-xs text-muted-foreground">
              <p><strong>Super Admin:</strong> superadmin@sante.gov.gn / SuperAdmin2025!</p>
              <p><strong>Admin Central:</strong> admin.central@sante.gov.gn / Admin2025!</p>
              <p><strong>Pharmacien:</strong> pharma.donka@sante.gov.gn / Pharma2025!</p>
            </div>
          </div>
        </div>
      </div>
